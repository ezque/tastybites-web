  ...
  >
    ...
    <div class="flex flex-row w-[90%] items-center justify-between">
        ...
        <div class="flex flex-row gap-2 ml-3 shrink-0">
            <button
            v-if="notif.type === 'report'"
            @click.stop="blockUser(notif)"
            class="w-[30px] h-[30px] rounded-full flex items-center justify-center cursor-pointer hover:translate-y-[-2px] transitio"
            >
                <img
                    src="/public/images/Button-icon/block.png"
                    alt="Block"
                    class="w-[20px] h-[20px]"
                />
            </button>
            ...
            >
                <img
                    src="/public/images/Button-icon/delete.png"
                    alt="Delete"
                    class="w-[20px] h-[20px]"
                />
            </button>
