<template>
    <div class="w-full h-[85vh] flex flex-col overflow-y-auto overflow-x-hidden gap-3">
        ...
        <template v-else>
            <template v-if="!props.searchQuery && !selectedFilter">
                <!-- Popular Recipes -->
                <h2 class="font-[Poppins-Bold] ml-22 text-[2rem] mb-0 p-0">Popular Recipes</h2>
                <div class="flex flex-wrap flex-row gap-[70px] items-center justify-center pt-4 pb-3 w-full shadow-[0_10px_10px_-5px_rgba(0,0,0,0.3)]">
                    <RecipeCard
